class Game {
            ...
            if(allPlayers !== undefined){
              ...
              // y = displayHeight - allPlayers[plr].distance;
                ...
                if (index === player.index){
                  ...
                  if(obstracles.isTouching(cars[index - 1])){
                    yVel -= 0.9;
                    slidingSound.play();
                  }
                }
        ...
        for(var plr in allPlayers){
          if(allplayers[plr].place === 1){
            ...
            text("2nd:" + allPlayers[plr].name, displayWidth/4, displayHeight/10 + 73);
          }
          else if(allplayers[plr].place === 3){
            text("3rd:" + allPlayers[plr].name, -4, displayHeight/10 + 76);
          }
          else{
            textSize(30);
